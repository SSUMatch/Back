...
public class QBlock extends EntityPathBase<Block> {
    ...
    private static final long serialVersionUID = -1773845749L;
    ...
    public final QUser requestingUser;
    ...
    public QBlock(Class<? extends Block> type, PathMetadata metadata, PathInits inits) {
        ...
        this.requestingUser = inits.isInitialized("requestingUser") ? new QUser(forProperty("requestingUser"), inits.get("requestingUser")) : null;
    }
